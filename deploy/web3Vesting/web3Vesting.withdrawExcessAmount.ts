...
const func: DeployFunction = async (hre: HardhatRuntimeEnvironment): Promise<void> => {
  await callWithTimerHre(async () => {
    ...
    console.log(`${WEB3_VESTING_NAME} ${web3VestingAddress} is withdrawing...`);
    ...
    await waitTx(
      owner2WEB3Vesting.withdrawExcessAmount(),
...
func.tags = [`${WEB3_VESTING_NAME}:withdraw-excess-amount`];
