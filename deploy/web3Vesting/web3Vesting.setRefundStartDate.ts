...
const func: DeployFunction = async (hre: HardhatRuntimeEnvironment): Promise<void> => {
  await callWithTimerHre(async () => {
    ...
    console.log(`${WEB3_VESTING_NAME} ${web3VestingAddress} is setting refund start date ...`);
    ...
    await waitTx(
      owner2WEB3Vesting.setRefundStartDate(params.value, TX_OVERRIDES),
      'setRefundStartDate',
...
func.tags = [`${WEB3_VESTING_NAME}:set-refund-start-date`];
